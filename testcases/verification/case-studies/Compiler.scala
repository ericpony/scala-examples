...
object Parser {
  ...
  def parsePhrase(ts: _root_.collection.List[Token]): Option[Expr] = {
    parseGoal(ts) match {
  ...
  def parseGoal(ts: _root_.collection.List[Token]): Option[(Expr, _root_.collection.List[Token])] = {
    parseOr(ts)
  }

  def parseOr(ts: _root_.collection.List[Token]): Option[(Expr, _root_.collection.List[Token])] = {
    parseAnd(ts) match {
  ...
  def parseAnd(ts: _root_.collection.List[Token]): Option[(Expr, _root_.collection.List[Token])] = {
    parseLT(ts) match {
  ...
  def parseLT(ts: _root_.collection.List[Token]): Option[(Expr, _root_.collection.List[Token])] = {
    parsePlus(ts) match {
  ...
  def parsePlus(ts: _root_.collection.List[Token]): Option[(Expr, _root_.collection.List[Token])] = {
    parseTimes(ts) match {
  ...
  def parseTimes(ts: _root_.collection.List[Token]): Option[(Expr, _root_.collection.List[Token])] = {
    parseLits(ts) match {
  ...
  def parseLits(ts: _root_.collection.List[Token]): Option[(Expr, _root_.collection.List[Token])] = ts match {
...
object Compiler {
  ...
  def parse(ts: _root_.collection.List[Token]): Option[Expr] = {
    parsePhrase(ts)
  } ensuring { _ match {
